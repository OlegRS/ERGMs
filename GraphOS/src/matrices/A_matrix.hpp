...
class A_matrix : public symm_matrix<bool> {//Adjacency matrix
  ...
  A_matrix& sample_AKS_model_with_single_link_Metropolis(const unsigned int &N_iters, prng& rnd, const double tau_1, const double mu, const double lambda, const bool &initialize_randomly=true, const double &temp=1);
